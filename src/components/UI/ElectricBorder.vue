...
<template>
    ...
    >
        <svg ref="svgRef"
            style="position: absolute; top: -9999px; left: -9999px; opacity: 0; width: 0; height: 0; pointer-events: none;"
        ...
        <div :style="{ ...inheritRadius, position: 'absolute', top: '0', right: '0', bottom: '0', left: '0', pointerEvents: 'none' }">
            <div ref="strokeRef" :style="{ ...strokeStyle, position: 'absolute', top: '0', right: '0', bottom: '0', left: '0', boxSizing: 'border-box' }" />
            <div :style="{ ...glow1Style, position: 'absolute', top: '0', right: '0', bottom: '0', left: '0', boxSizing: 'border-box' }" />
            <div :style="{ ...glow2Style, position: 'absolute', top: '0', right: '0', bottom: '0', left: '0', boxSizing: 'border-box' }" />
            <div :style="{ ...bgGlowStyle, position: 'absolute', top: '0', right: '0', bottom: '0', left: '0' }" />
        </div>

        <div :style="{ ...inheritRadius, position: 'relative' }">
            <slot />
        </div>
    </div>
</template>
